...
CREATE TABLE sttgaz.stage_crm_stats (
    ...
    "RLnaEtapePervichniyKontactPC" varchar(800),
    "RLnaEtapePotrebnosti" varchar(800),
    "RLnaEtapePotrebnostiPC" varchar(800),
    "RLnaNachalnihEtapahPervichniyContactPotrebnosti" varchar(800),
    "RLnaNachalnihEtapahPervichniyContactPotrebnostiPC" varchar(800),
    "SootvetstvieTrebovaniyam1" varchar(800),
    "RLsNenaznachennimSleduyushimSobitiem" varchar(800),
    "RLsNenaznachennimSleduyushimSobitiemPC" varchar(800),
