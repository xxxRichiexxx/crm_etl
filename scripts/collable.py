...
def transform(data, execution_date, table_name):
    ...
    if table_name in ('stage_crm_requests', 'stage_crm_requests_paz'):
        ...
        data.columns = [
            ...
            'RLnaEtapePervichniyKontactPC',
            'RLnaEtapePotrebnosti',
            'RLnaEtapePotrebnostiPC',
            'RLnaNachalnihEtapahPervichniyContactPotrebnosti',
            'RLnaNachalnihEtapahPervichniyContactPotrebnostiPC',
            'SootvetstvieTrebovaniyam1',
            'RLsNenaznachennimSleduyushimSobitiem',
            'RLsNenaznachennimSleduyushimSobitiemPC',
